...
import Juego.Juego;
import Juego.Online.Servidor.Servidor;
 ...
 * @author Joel
 */
public class SeleccionMultijugador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("¿Dónde comenzará tu Maharajá?");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            executor.execute(new Servidor());
            executor.execute(new Juego(true, true, "Cipayos", "Maharajá", x, y));
        } 
        catch (Exception e) { }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeleccionMultijugador().setVisible(true);
            }
        });
    }
